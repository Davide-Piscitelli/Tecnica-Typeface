const CONFIG = {
  ...
  families: [
    ...
    { id: 'tecnica-mono', name: 'Tecnica-Mono', displayName: 'Tecnica Mono' },
    { id: 'tecnica-53line', name: 'Tecnica-53Line', displayName: 'Tecnica 53 Line' },
    { id: 'tecnica-55line', name: 'Tecnica-55Line', displayName: 'Tecnica 55 Line' },
    { id: 'tecnica-monoline', name: 'Tecnica-MonoLine', displayName: 'Tecnica Mono Line' }
  ],
  samples: {
