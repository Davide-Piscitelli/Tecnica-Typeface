...
This typeface is completely open-source and distributed under the **SIL Open Font License v1.1**. 
* **Permissions**: Free for both personal and commercial use. You may use, study, modify, and redistribute the font software freely.
* **Conditions**: The font software cannot be sold on its own. Derivative works must not use the Reserved Font Names and must remain under the same license.
* **Attribution**: Please credit the original designer, Davide Piscitelli, when publishing projects that feature this typeface.
